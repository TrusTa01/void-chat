...
mixin _$RegisterRequestDto {
 ...
 String get login; String get password; String get email; String get username;@JsonKey(name: 'display_name') String get displayName;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,login,password,email,username,displayName);

@override
String toString() {
  return 'RegisterRequestDto(login: $login, password: $password, email: $email, username: $username, displayName: $displayName)';
}
...
@useResult
$Res call({
 String login, String password, String email, String username,@JsonKey(name: 'display_name') String displayName
});
...
/// Create a copy of RegisterRequestDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? login = null,Object? password = null,Object? email = null,Object? username = null,Object? displayName = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String login,  String password,  String email,  String username, @JsonKey(name: 'display_name')  String displayName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterRequestDto() when $default != null:
return $default(_that.login,_that.password,_that.email,_that.username,_that.displayName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String login,  String password,  String email,  String username, @JsonKey(name: 'display_name')  String displayName)  $default,) {final _that = this;
switch (_that) {
case _RegisterRequestDto():
return $default(_that.login,_that.password,_that.email,_that.username,_that.displayName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String login,  String password,  String email,  String username, @JsonKey(name: 'display_name')  String displayName)?  $default,) {final _that = this;
switch (_that) {
case _RegisterRequestDto() when $default != null:
return $default(_that.login,_that.password,_that.email,_that.username,_that.displayName);case _:
  return null;
...
class _RegisterRequestDto implements RegisterRequestDto {
  const _RegisterRequestDto({required this.login, required this.password, required this.email, required this.username, @JsonKey(name: 'display_name') required this.displayName});
...
/// Create a copy of RegisterRequestDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? login = null,Object? password = null,Object? email = null,Object? username = null,Object? displayName = null,}) {
